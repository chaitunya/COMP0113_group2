    ...
    private IEnumerator SetRandomCostume()
    {
        while (true)
        {
            ...
            {    
                ...
                if (textured)
                {
                    // Set a random texture for each body part.
                    foreach (BodyPart part in Enum.GetValues(typeof(BodyPart)))
                    {
                        ...
                        // string uuid = textureUuids[bodyPart];
                        
                        // Set the texture for the body part.
                        textured.SetTexture(randomCostume, part);
                    }

                    // End the coroutine after updating the textures.
                    yield break;
                }
            }
